...
- Strict-контракт конфигов: при отсутствии/битом конфиге приложение завершает инициализацию с явной ошибкой и логированием через `AppLogger` (без подстановки встроенных дефолтов).
